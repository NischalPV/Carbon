...
namespace Carbon.Identity.Data.Migrations.ApplicationDb
{
    ...
    [Migration("20230305062146_data.users.update")]
    partial class datausersupdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Carbon.Identity.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NormalizedEmail = "ADMIN.CARBON@HOTMAIL.COM",
                            NormalizedUserName = "+919888888888",
                            PasswordHash = "AQAAAAIAAYagAAAAEOTfRoJUsngVOoQww1sfGfcs4NLC7SzxnsuL/DZrHUZmUDqJdm/XBzi7uqZeUw3RnA==",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Carbon.Identity.Models.ApplicationUser", null)
                        .WithMany()
