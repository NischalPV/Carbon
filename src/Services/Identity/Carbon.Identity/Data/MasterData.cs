...
namespace Carbon.Identity.Data;
...
public class MasterData
{
    ...
    private static void DefaultUsers(ModelBuilder modelBuilder)
    {
        ...
        users.Add(new ApplicationUser(createdDate: new DateTime(2021, 12, 15, 0, 0, 0, DateTimeKind.Utc))
        {
            ...
            NormalizedEmail = "admin.carbon@hotmail.com".ToUpper(),
            EmailConfirmed = true,
            PhoneNumberConfirmed = true,
            PasswordHash = "carbon@2023", // This is actual password. DO NOT use this password directly. We need to hash it before storing it.
