...
namespace Carbon.Identity.Data.Migrations.IdentityServer.ConfigurationDb
{
    ...
    [Migration("20230306083246_data.clientSecrets.update")]
    partial class dataclientSecretsupdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ApiScope", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 3, 6, 8, 32, 46, 340, DateTimeKind.Utc).AddTicks(2080),
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ClientSecret", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 2,
                            Created = new DateTime(2023, 3, 6, 8, 32, 46, 340, DateTimeKind.Utc).AddTicks(2660),
                            Type = "SharedSecret",
                            Value = "System.Byte[]"
                        });
                });
