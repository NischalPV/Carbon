...
namespace Carbon.Identity.Data.Migrations.IdentityServer.ConfigurationDb
{
    ...
    [Migration("20230306081007_data.clientSecrest.update")]
    partial class dataclientSecrestupdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ApiScope", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 3, 6, 8, 10, 7, 441, DateTimeKind.Utc).AddTicks(7000),
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ClientSecret", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 2,
                            Created = new DateTime(2023, 3, 6, 8, 10, 7, 441, DateTimeKind.Utc).AddTicks(7580),
                            Type = "SharedSecret",
                            Value = "carbon@2023"
                        });
                });
